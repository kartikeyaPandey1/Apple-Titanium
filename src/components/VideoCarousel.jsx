  ...
  return (
    ...
    <div className="flex items-center ">
        ...
        {hightlightsSlides.map((list,i)=>(
            <div key={list.id} id="slider" className="pr-10 pt-10">
                ...
                <div className="video-carousel_container">
                    ...
                    <div className="absolute top-12 z-10">
                        {list.textLists.map((text)=>(
                            ...
                            <p key={text} className="text-xl pl-10 font-medium">
    ...
    <div className="relative flex-center mt-12">
        <div className="flex-center py-5 px-8 bg-gray-300 backdrop-blur rounded-full">
            ...
            {videoRef.current.map(( _,i)=>(
                ...
                className="mx-2 w-3 h-3 cursor-pointer bg-gray-200 rounded-full relative "
                >
